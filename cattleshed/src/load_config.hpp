...
typedef mendex::multi_index_container<
    ...
    mendex::indexed_by<
        mendex::sequenced<>,
        mendex::hashed_unique<
            mendex::member<switch_trait, std::string, &switch_trait::name>>,
        mendex::hashed_non_unique<mendex::member<switch_trait, std::string,
                                                 &switch_trait::group_name>>>>
    local_switch_t;
...
typedef mendex::multi_index_container<
    ...
    mendex::indexed_by<
        mendex::sequenced<>,
        mendex::hashed_unique<mendex::member<compiler_trait, std::string,
                                             &compiler_trait::name>>>>
    compiler_set;
