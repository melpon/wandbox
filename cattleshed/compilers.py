...
class Switches(object):
    ...
    def make_boost(self):
        pairs = [
            ...
            ("boost-1.58", {
                "flags":["-I/usr/local/boost-1.58.0/include", "-L/usr/local/boost-1.58.0/lib", "-Wl,-rpath,/usr/local/boost-1.58.0/lib", "-lboost_wserialization", "-lboost_math_tr1f", "-lboost_math_c99l", "-lboost_math_tr1", "-lboost_locale", "-lboost_wave", "-lboost_regex", "-lboost_prg_exec_monitor", "-lboost_atomic", "-lboost_signals", "-lboost_math_c99f", "-lboost_context", "-lboost_program_options", "-lboost_coroutine", "-lboost_serialization", "-lboost_filesystem", "-lboost_system", "-lboost_timer", "-lboost_log_setup", "-lboost_random", "-lboost_chrono", "-lboost_exception", "-lboost_iostreams", "-lboost_thread", "-lboost_date_time", "-lboost_math_c99", "-lboost_math_tr1l", "-lboost_graph", "-lboost_log"],
                "display-name":"Boost 1.58.0",
                "display-flags":"-I/usr/local/boost-1.58.0/include",
            }),
            ("boost-1.59", {
                "flags":["-I/usr/local/boost-1.59.0/include", "-L/usr/local/boost-1.59.0/lib", "-Wl,-rpath,/usr/local/boost-1.59.0/lib", "-lboost_wserialization", "-lboost_math_tr1f", "-lboost_math_c99l", "-lboost_math_tr1", "-lboost_locale", "-lboost_wave", "-lboost_regex", "-lboost_prg_exec_monitor", "-lboost_atomic", "-lboost_signals", "-lboost_math_c99f", "-lboost_context", "-lboost_program_options", "-lboost_coroutine", "-lboost_serialization", "-lboost_filesystem", "-lboost_system", "-lboost_timer", "-lboost_log_setup", "-lboost_random", "-lboost_chrono", "-lboost_exception", "-lboost_iostreams", "-lboost_thread", "-lboost_date_time", "-lboost_math_c99", "-lboost_math_tr1l", "-lboost_graph", "-lboost_log"],
                "display-name":"Boost 1.59.0",
                "display-flags":"-I/usr/local/boost-1.59.0/include",
            }),
            ("boost-1.60", {
                "flags":["-I/usr/local/boost-1.60.0/include", "-L/usr/local/boost-1.60.0/lib", "-Wl,-rpath,/usr/local/boost-1.60.0/lib", "-lboost_wserialization", "-lboost_math_tr1f", "-lboost_math_c99l", "-lboost_math_tr1", "-lboost_locale", "-lboost_wave", "-lboost_regex", "-lboost_prg_exec_monitor", "-lboost_atomic", "-lboost_signals", "-lboost_math_c99f", "-lboost_context", "-lboost_program_options", "-lboost_coroutine", "-lboost_serialization", "-lboost_filesystem", "-lboost_system", "-lboost_timer", "-lboost_log_setup", "-lboost_random", "-lboost_chrono", "-lboost_exception", "-lboost_iostreams", "-lboost_thread", "-lboost_date_time", "-lboost_math_c99", "-lboost_math_tr1l", "-lboost_graph", "-lboost_log"],
                "display-name":"Boost 1.60.0",
                "display-flags":"-I/usr/local/boost-1.60.0/include",
            }),
            ("boost-1.61", {
                "flags":["-I/usr/local/boost-1.61.0/include", "-L/usr/local/boost-1.61.0/lib", "-Wl,-rpath,/usr/local/boost-1.61.0/lib", "-lboost_wserialization", "-lboost_math_tr1f", "-lboost_math_c99l", "-lboost_math_tr1", "-lboost_locale", "-lboost_wave", "-lboost_regex", "-lboost_prg_exec_monitor", "-lboost_atomic", "-lboost_signals", "-lboost_math_c99f", "-lboost_context", "-lboost_program_options", "-lboost_coroutine", "-lboost_serialization", "-lboost_filesystem", "-lboost_system", "-lboost_timer", "-lboost_log_setup", "-lboost_random", "-lboost_chrono", "-lboost_exception", "-lboost_iostreams", "-lboost_thread", "-lboost_date_time", "-lboost_math_c99", "-lboost_math_tr1l", "-lboost_graph", "-lboost_log"],
    ...
    def make_default(self):
        return {
            ...
            "spirit-x3":{
                "flags":["-I/usr/local/spirit_x3/include"],
                "display-name":"Spirit X3",
                "display-flags":"-I/usr/local/spirit_x3/include",
            },
            "msgpack":{
...
class Compilers(object):
    ...
    def make_gcc(self):
        ...
        SWITCHES_BOOST = ["boost-nothing", "boost-1.47", "boost-1.48", "boost-1.49", "boost-1.50", "boost-1.51", "boost-1.52", "boost-1.53", "boost-1.54", "boost-1.55", "boost-1.56", "boost-1.57", "boost-1.58", "boost-1.59", "boost-1.60", "boost-1.61"]
        SWITCHES_PEDANTIC = ["cpp-no-pedantic", "cpp-pedantic", "cpp-pedantic-errors"]
        NAMES = [
            ("gcc-head", {
                "params": {},
                "after": {
                    ...
                    "switches": SWITCHES_DEFAULT + ["spirit-x3"] + SWITCHES_BOOST + ["sprout", "msgpack", "c++98", "gnu++98", "c++11", "gnu++11", "c++14", "gnu++14", "c++1z", "gnu++1z"] + SWITCHES_PEDANTIC,
                    "initial-checked":["warning", "gnu++1z", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-6.1.0", {
                "params": {},
            ...
            ("gcc-5.1.0", {
                "params": {},
                "after": {
                    "switches": SWITCHES_DEFAULT + ["spirit-x3"] + SWITCHES_BOOST + ["sprout", "msgpack", "c++98", "gnu++98", "c++11", "gnu++11", "c++1y", "gnu++1y", "c++1z", "gnu++1z"] + SWITCHES_PEDANTIC,
                    "initial-checked":["warning", "gnu++1z", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.9.3", {
                "params": {},
                "after": {
                    "switches": SWITCHES_DEFAULT + ["spirit-x3"] + SWITCHES_BOOST + ["sprout", "msgpack", "c++98", "gnu++98", "c++11", "gnu++11", "c++1y", "gnu++1y"] + SWITCHES_PEDANTIC,
                    "initial-checked":["warning", "gnu++1y", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.9.2", {
                "params": {},
            ...
            ("gcc-4.7.3", {
                ...
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++11", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.6.4", {
                "params": {},
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++0x", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.5.4", {
                "params": {},
                "after": {
                    "switches": SWITCHES_DEFAULT + SWITCHES_BOOST + ["c++98", "gnu++98", "c++0x", "gnu++0x"] + SWITCHES_PEDANTIC,
                    "initial-checked":["warning", "gnu++0x", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.4.7", {
                ...
                "after": {
                    ...
                    "initial-checked":["oldgcc-warning", "gnu++0x", "boost-1.61", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.3.6", {
                "params": {},
                "after": {
                    ...
                    "initial-checked":["oldgcc-warning", "gnu++0x", "cpp-no-pedantic"],
                },
            })
        ]
        FORMATS = {
        ...
        NAMES = [
            ...
            ("clang-3.7", {
                ...
                "after": {
                    ...
                    "version-command":["/bin/sh", "-c", "LD_LIBRARY_PATH=/usr/local/gcc-4.8.2/lib64 /usr/local/llvm-3.7/bin/clang++ --version | head -1 | cut -d' ' -f3-"],
                },
                "lsupc++": True,
            }),
            ("clang-3.6", {
            ...
            ("clang-3.1", {
                ...
                "after": {
                    "switches": SWITCHES_DEFAULT + SWITCHES_BOOST + ["c++98", "gnu++98", "c++11", "gnu++11"] + SWITCHES_PEDANTIC,
                    "initial-checked":["warning", "gnu++11", "boost-1.61", "cpp-no-pedantic"],
                },
                "lsupc++": False,
            }), 
