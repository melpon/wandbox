...
class Compilers(object):
    ...
    def make_gcc(self):
        ...
        SWITCHES_BOOST = ["boost-nothing", "boost-1.47", "boost-1.48", "boost-1.49", "boost-1.50", "boost-1.51", "boost-1.52", "boost-1.53", "boost-1.54", "boost-1.55", "boost-1.56", "boost-1.57", "boost-1.58", "boost-1.59"]
        ...
        NAMES = [
            ...
            ("gcc-4.5.4", {
                ...
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++0x", "boost-1.59", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.4.7", {
                "params": {},
                "after": {
                    ...
                    "initial-checked":["oldgcc-warning", "gnu++0x", "boost-1.59", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.3.6", {
                "params": {},
        ...
        NAMES = [
            ...
            ("clang-3.1", {
                ...
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++11", "boost-1.59", "cpp-no-pedantic"],
                },
                "lsupc++": False,
            }), 
            ("clang-3.0", {
    ...
    def make_swift(self):
        ...
        FORMATS = {
            ...
            "version-command":["/bin/sh", "-c", "/usr/local/{name}/bin/swiftc --version | head -1 | cut -d' ' -f3"],
            "display-name":"swift",
