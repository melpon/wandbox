...
class Compilers(object):
    ...
    def make_gcc(self):
        ...
        SWITCHES_BOOST = ["boost-nothing", "boost-1.47", "boost-1.48", "boost-1.49", "boost-1.50", "boost-1.51", "boost-1.52", "boost-1.53", "boost-1.54", "boost-1.55", "boost-1.56", "boost-1.57", "boost-1.58", "boost-1.59", "boost-1.60"]
        ...
        NAMES = [
            ...
            ("gcc-4.9.2", {
                ...
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++1y", "boost-1.60", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.9.1", {
                "params": {},
            ...
            ("gcc-4.7.3", {
                ...
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++11", "boost-1.60", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.6.4", {
                "params": {},
                "after": {
                    ...
                    "initial-checked":["warning", "gnu++0x", "boost-1.60", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.5.4", {
                "params": {},
            ...
            ("gcc-4.4.7", {
                ...
                "after": {
                    ...
                    "initial-checked":["oldgcc-warning", "gnu++0x", "boost-1.60", "cpp-no-pedantic"],
                },
            }),
            ("gcc-4.3.6", {
                "params": {},
